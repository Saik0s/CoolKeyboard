...
- (void)randomStyle:(UInt32)selected {
    NSArray *colors = [[NSArray alloc] initWithObjects:
                       [NSArray arrayWithObjects:
                        [NSNumber numberWithDouble:190.0/360.0],
                        [NSNumber numberWithDouble:0.55],
                        [NSNumber numberWithDouble:0.91],
                        [NSNumber numberWithBool:YES],
                        nil],
                       [NSArray arrayWithObjects:
                        [NSNumber numberWithDouble:177.0/360.0],
                        [NSNumber numberWithDouble:0.24],
                        [NSNumber numberWithDouble:0.86],
                        [NSNumber numberWithBool:YES],
                        nil],
                       [NSArray arrayWithObjects:
                        [NSNumber numberWithDouble:70.0/360.0],
                        [NSNumber numberWithDouble:0.11],
                        [NSNumber numberWithDouble:0.89],
                        [NSNumber numberWithBool:YES],
                        nil],
                       [NSArray arrayWithObjects:
                        [NSNumber numberWithDouble:26.0/360.0],
                        [NSNumber numberWithDouble:0.80],
                        [NSNumber numberWithDouble:0.95],
                        [NSNumber numberWithBool:YES],
                        nil],
                       [NSArray arrayWithObjects:
                        [NSNumber numberWithDouble:25.0/360.0],
                        [NSNumber numberWithDouble:1.0],
                        [NSNumber numberWithDouble:0.98],
                        [NSNumber numberWithBool:YES],
                        nil],
                       [NSArray arrayWithObjects:
                        [NSNumber numberWithDouble:202.0/360.0],
                        [NSNumber numberWithDouble:0.90],
                        [NSNumber numberWithDouble:0.42],
                        [NSNumber numberWithBool:NO],
                        nil],
                       [NSArray arrayWithObjects:
                        [NSNumber numberWithDouble:180.0/360.0],
                        [NSNumber numberWithDouble:0.56],
                        [NSNumber numberWithDouble:0.53],
                        [NSNumber numberWithBool:NO],
                        nil],
                       [NSArray arrayWithObjects:
                        [NSNumber numberWithDouble:149.0/360.0],
                        [NSNumber numberWithDouble:0.36],
                        [NSNumber numberWithDouble:0.74],
                        [NSNumber numberWithBool:YES],
                        nil],
                       nil];
    
    int selectedColor = selected;//arc4random() % colors.count;
    
    
    [self bootstrapStyle];
    self.backgroundColor = [UIColor colorWithHue:[colors[selectedColor][0] doubleValue]
                                      saturation:[colors[selectedColor][1] doubleValue]
                                      brightness:[colors[selectedColor][2] doubleValue] alpha:1];
    self.layer.borderColor = [[UIColor colorWithHue:[colors[selectedColor][0] doubleValue]
                                         saturation:[colors[selectedColor][1] doubleValue]
                                         brightness:[colors[selectedColor][2] doubleValue]-0.04 alpha:1] CGColor];
    
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithHue:[colors[selectedColor][0] doubleValue]
                                                                   saturation:[colors[selectedColor][1] doubleValue]
                                                                   brightness:[colors[selectedColor][2] doubleValue] + 0.04 alpha:1]]
                    forState:UIControlStateHighlighted];
    
    if ([colors[selectedColor][3] boolValue]) {
    ...
    /*
    [self bootstrapStyle];
    self.backgroundColor = [UIColor colorWithRed:104/255.0 green:211/255.0 blue:232/255.0 alpha:1];
    self.layer.borderColor = [[UIColor colorWithRed:98/255.0 green:197/255.0 blue:217/255.0 alpha:1] CGColor];
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithRed:108/255.0 green:218/255.0 blue:240/255.0 alpha:1]] forState:UIControlStateHighlighted];
     */
}
