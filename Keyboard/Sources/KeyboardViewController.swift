...
class KeyboardViewController: UIInputViewController {
  ...
  func installButtons() {
    ...
    addConstraintsToInputView(view, rowViews: [row1, row2, row3, row4])
  }
  ...
  override func textWillChange(textInput _: UITextInput) {
    // The app is about to change the document's contents. Perform any preparation here.
  }

  override func textDidChange(textInput _: UITextInput) {
      ...
      if index == 0 {
        ...
        if currentRow == 3 {
          var widthConstraint = NSLayoutConstraint(
            ...
            multiplier: 1.0,
            constant: UIScreen.mainScreen().bounds.width / 8
          )
        ...
        if currentRow == 3 && index == 1 {
          ...
          var widthConstraint = NSLayoutConstraint(
            ...
            attribute: .NotAnAttribute,
            multiplier: 1.0,
            constant: UIScreen.mainScreen().bounds.width / 4
          )
